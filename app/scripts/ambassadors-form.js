    ...
    $.ajax({
    ...
    }).done(function(msg)
      {
        if(msg === 'OK'){
          ...
          $('.dao-thanks').html('<p>Thanks for your interest in the DaoCloud Ambassador Program!</p><p>We are reviewing your application, and may contact you soon.</p><p>Good luck!</p>').show().fadeIn();
        }
        else {
